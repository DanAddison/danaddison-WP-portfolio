...
function signal_scripts() {
	// styles
	wp_enqueue_style( 'main-style', get_template_directory_uri() . '/assets/compiled/style.css', array(), '1.1.1', 'all' );

	// enqueue google fonts
	wp_enqueue_style( 'signal-fonts', 'https://fonts.googleapis.com/css?family=Poppins:400,700|Roboto+Slab:400,700&display=swap' );

	// scripts
	wp_enqueue_script( 'footer-scripts', get_template_directory_uri() . '/assets/compiled/footer.js', array('jquery'), '1.1.1', true );
