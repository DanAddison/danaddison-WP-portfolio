...
function signal_register_blocks() {
	...
	if( ! function_exists( 'acf_register_block_type' ) )
		...
		acf_register_block_type(array(
			'name'				 => 'spacing',
			'title'	 		   	 => __('Spacing'),
			'description'		 => __('A custom block for inserting responsive vertical whitespace between other blocks'),
		...
		acf_register_block_type(array(
			...
			'description'		  => __('A custom block for adding a responsive fullwidth background image.'),
			'render_callback'	=> 'signal_acf_block_render_callback',
			'category'			  => 'nebulo-blocks',
			'mode'						=> 'edit',
		...
		acf_register_block_type(array(
			'name'			  	  => 'link-card',
			'title'				    => __('Link Card'),
			'description'		  => __('A custom block for adding an image which links anywhere. Place these within a Columns block.'),
			'render_callback'	=> 'signal_acf_block_render_callback',
			'category'			  => 'nebulo-blocks',
			'mode'						=> 'edit',
