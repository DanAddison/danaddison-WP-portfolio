...
// serving an existing image size into the product gallery, instead of the gallery_thumbnail size (for when we want large images instead of thumbs and lightboxes etc)
